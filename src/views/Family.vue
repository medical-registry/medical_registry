            ...
            <v-card-text>
                <v-simple-table>
                  <template v-slot:default>
                   <thead>
                          <tr>
                            <th v-if="item.parental_type" class="text-left">Grado di Parentela</th>
                            <th v-if="item.body_impacted" class="text-left">Parte del corpo</th>
                            <th v-if="item.body_impacted" class="text-left">Scoperto all'età di</th>
                    ...
                    <tbody>
                        <tr>
                        <td v-if="item.parental_type" class="text-left">{{item.parental_type}}</td>
